...
class RegistrarSeviciosMascota : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val btnPublicar : Button = findViewById(R.id.botonFinalRegistarServicio)
        btnPublicar.setOnClickListener()
        {
            val db = FirebaseFirestore.getInstance()
            val txt_titulo : TextView = findViewById(R.id.tituloRegistrarMascotaPerdida3)
            val txt_descipcion: TextView = findViewById(R.id.descripcionRegistrarMascotaPerdida3)
